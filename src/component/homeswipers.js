  ...
  render() {
    return (
      <Swiper style={styles.wrapper} autoplay={true} paginationStyle={{top:  ScreenWidth * 540 / 1080 -210}} 
        ...
        <View><Image resizeMode='cover' style={styles.imageSwiper} source={require('../img/home/header-1.jpg')} /></View>
        <View><Image resizeMode='cover' style={styles.imageSwiper} source={require('../img/home/header-2.jpg')} /></View>
        <View><Image resizeMode='cover' style={styles.imageSwiper} source={require('../img/home/header-3.jpg')} /></View>
      </Swiper>
    );
  }
})
